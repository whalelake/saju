        ...
        <div className="hero-content text-center">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold mb-4">
              <span className="gold-accent text-5xl sm:text-6xl">{t.display.brandName}</span>
            ...
            <button
              onClick={onStart}
              className="btn btn-primary btn-lg gap-2 shadow-lg mb-8"
            >
              <span>{t.display.brandChar}</span> {t.hero.cta}
            ...
            <div className="stats stats-vertical sm:stats-horizontal shadow mt-12 bg-base-100">
              <div className="stat">
                ...
                <div className="stat-value text-primary text-2xl">{t.display.sajuStat}</div>
                <div className="stat-desc">{t.hero.sajuDesc}</div>
              </div>
              <div className="stat">
                <div className="stat-title">{t.hero.ziwei}</div>
                <div className="stat-value text-secondary text-2xl">{t.display.ziweiStat}</div>
                <div className="stat-desc">{t.hero.ziweiDesc}</div>
              </div>
              <div className="stat">
                <div className="stat-title">{t.hero.natal}</div>
                <div className="stat-value text-accent text-2xl">{t.display.natalStat}</div>
